...
import esper.base.reader.FtpReader;
import esper.base.storm.BaseSpoutImpl;
import esper.utility.mq.MQFactory;
        ...
        try {
            ...
            while (true) {
                ...
                if (message != null) {
                    ...
                    BufferedReader bufferedReader = ftpReader.read(message);
